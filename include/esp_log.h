 ...
 * @see ``printf``
 */
/* ONLY support a single time format, do not build hard-coded format strings (EWIDV)
 * Simplify the macro definitions to a single macro (for now till C++ 2017 support) */
#if defined(__cplusplus) && (__cplusplus >  201703L)
